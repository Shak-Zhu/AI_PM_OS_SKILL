...
- **禁止**将建议动作直接写入 `PM_TODO.md`（须经用户确认）
...
5. 来源必须可追踪：`source` 只能为 `PM_RAID_LOG.md`、`PM_MEETING_MINUTES.md`、`PM_APPROVAL_STATUS.md`、用户直接创建之一
...
| `PM_MEETING_MINUTES.md` | `Draft` / `Approved` | 含会议纪要和 Decision |
